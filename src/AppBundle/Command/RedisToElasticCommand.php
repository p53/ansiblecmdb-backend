...
class RedisToElasticCommand extends ContainerAwareCommand {
    
    protected function configure()
    {
        $this
            ->setName('redistoelastic:index')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if (!$elasticIndashIndex->exists()) {
            $elasticIndashIndex->create(array(), false);
        }
        ...
        $typeConfig = $configManager->getTypeConfiguration('app', 'host');
